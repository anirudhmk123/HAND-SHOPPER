      ...
      <div class="container">
        <div class="row">
          <div class="col-md-4 clearfix">
            ...
            <a href="<?php echo web_root; ?>index.php" > <h2><span>HAND</span>-shopper</h2> </a>
            </div>
    ...
    <div class="footer-top">
      <div class="container">
        <div class="row">
            ...
            <div class="companyinfo">
              <center><h2><span>HAND</span>-shopper</h2></center>
              <p>As this pandemic has hit the local merchants very badly, this system can enhance their offline services to a hybrid market. The customers can also take advantages of delivery at doorstep and shopping without physically being present there. This system has a future scope even after the pandemic for safe and effortless shopping experience to the customers. Implementing a mobile application in the future can enhance the seller involvement and better user experience</p>
            </div>
